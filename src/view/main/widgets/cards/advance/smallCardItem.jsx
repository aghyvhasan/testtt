...
export default function SmallCardItem(props) {
  ...
  return (
    <div
      className="hp-d-flex hp-d-flex-between hp-d-flex-column hp-border-radius-xxl hp-overflow-hidden hp-card-1 hp-p-18 checkoutSelectedWallet"
      style={{ backgroundImage: "url(" + bg + ")", backgroundSize: "cover", backgroundPosition: "center right", height: "100%" }}
    ...
    >
      ...
      <Row align="middle" justify="space-between">
        <Col>
          <span className="h4 hp-text-color-black-0 checkoutSelectedWalletLabel">Selected</span>
        </Col>
