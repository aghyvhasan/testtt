              ...
              <div key={value.id}>
                ...
                >
                  <Row align="middle" justify="space-between" wrap={false}>
                    <Col
                      flex="1 0 0"
                      className="hp-basket-dropdown-list-item-title"
                    >
                      <Row wrap={false}>
                        ...
                        <Col
                          flex="0 0 90px"
                          className="hp-d-flex hp-d-flex-column hp-ml-18"
                        >
                          <InputNumber
                            min={1}
                            max={99}
              ...
              <Col span={12}>
                ...
                >
                  <Button
                    block
                    type="text"
                    className="hp-text-color-black-0 hp-bg-black-100 hp-hover-bg-primary-1"
                  >
                    Checkout
                  </Button>
                </Link>
