...
const PagesRoutes = [
  ...
  {
    path: "/main/dashboard/upcomings",
    component: lazy(() => import("../../view/main/dashboard/upcomings")),
    layout: "VerticalLayout",
  },
  {
    path: "/main/dashboard/history",
    component: lazy(() => import("../../view/main/dashboard/history")),
    layout: "VerticalLayout",
  },
  {
    path: "/main/dashboard/lotteryDetail",
    component: lazy(() => import("../../view/main/dashboard/lotteryDetail")),
    layout: "VerticalLayout",
  },
  {
  ...
  {
    path: "/apps/ecommerce/orderSuccess",
    component: lazy(() => import("../../view/apps/ecommerce")),
    layout: "VerticalLayout",
  },
  {
  ...
  {
    path: "/apps/ecommerce/invoiceDetail",
    component: lazy(() => import("../../view/apps/ecommerce")),
    layout: "VerticalLayout",
  },
  {
    path: "/apps/ecommerce/passedLotteryDetails",
    component: lazy(() => import("../../view/apps/ecommerce")),
    layout: "VerticalLayout",
  },
  {
    path: "/apps/ecommerce/orderDetail",
    component: lazy(() => import("../../view/apps/ecommerce")),
    layout: "VerticalLayout",
  },
  {
  ...
  {
    path: "/pages/profile/email-confirm",
    component: lazy(() => import("../../view/pages/profile")),
    layout: "VerticalLayout",
  },
  {
