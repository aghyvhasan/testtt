...
export default function HotBidNFT(props) {
  const { lotteryListData } = props
  ...
  return (
    <>
      <Row align="middle" justify="space-between" className="hp-mb-32">
        <Col>
          <span className="h3 hp-text-color-black-100 hp-text-color-dark-0">Hot Lotteries 🔥</span>
        </Col>
          ...
          <>
            {
              ...
              <Swiper {...params} ref={swiperRef1}>
                {
                  lotteryListData.map((item, index) => (
                    <div key={index}>
